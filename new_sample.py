...
def build_graph(top_k):
    with tf.device('/cpu:0'):
        ...
        conv_2 = slim.conv2d(max_pool_1, 200, [3, 3], padding='SAME', scope='conv2')
        max_pool_2 = slim.max_pool2d(conv_2, [2, 2], [2, 2], padding='SAME')
        
        conv_3 = slim.conv2d(max_pool_2, 300, [3, 3], padding='SAME', scope='conv3')
        max_pool_3 = slim.max_pool2d(conv_3, [2, 2], [2, 2], padding='SAME')

        conv_4 = slim.conv2d(max_pool_3, 400, [3, 3], padding='SAME', scope='conv4')
        max_pool_4 = slim.max_pool2d(conv_4, [2, 2], [2, 2], padding='SAME')

        conv_5 = slim.conv2d(max_pool_4, 500, [3, 3], padding='SAME', scope='conv5')
        max_pool_5 = slim.max_pool2d(conv_5, [2, 2], [2, 2], padding='SAME')

        conv_6 = slim.conv2d(max_pool_5, 600, [3, 3], padding='SAME', scope='conv6')
        max_pool_6 = slim.max_pool2d(conv_6, [2, 2], [2, 2], padding='SAME')

        conv_7 = slim.conv2d(max_pool_7, 700, [3, 3], padding='SAME', scope='conv7')
